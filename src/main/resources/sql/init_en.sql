...
VALUES 
('Zhang San', 'M', '1990-01-15', '13800138001', 'zhangsan@example.com', 'Intermediate', 2, 1000, 500.00),
('Li Si', 'F', '1992-05-20', '13800138002', 'lisi@example.com', 'Beginner', 1, 500, 200.00),
('Wang Wu', 'M', '1988-08-10', '13800138003', 'wangwu@example.com', 'Advanced', 3, 2000, 1000.00);

-- Insert test coach data
INSERT INTO `coach_info` (`coach_name`, `gender`, `birth_date`, `phone_num`, `email_addr`, `specialty`, `experience_years`, `certification`, `status`) 
VALUES 
('Coach Zhao', 'M', '1985-03-12', '13900139001', 'zhao@gym.com', 'Weight Loss', 5, 'ACE Certified', 1),
('Coach Qian', 'F', '1990-07-25', '13900139002', 'qian@gym.com', 'Yoga Pilates', 3, 'RYT Certified', 1);
...
VALUES 
('Weight Loss Training', 1, 'Group', 'High intensity interval training', 60, 100.00, 20, 5, '2024-01-15 10:00:00', '2024-01-15 11:00:00', 0, 'Room 1'),
('Yoga Basic', 2, 'Group', 'Yoga basic course for beginners', 90, 80.00, 15, 8, '2024-01-15 14:00:00', '2024-01-15 15:30:00', 0, 'Yoga Room'),
('Personal Muscle Building', 1, 'Private', 'One-on-one muscle building training', 60, 300.00, 1, 0, '2024-01-16 09:00:00', '2024-01-16 10:00:00', 0, 'Weight Area');

-- Insert test equipment data
INSERT INTO `equipment_info` (`equipment_name`, `type`, `brand`, `model`, `status`, `purchase_date`, `last_maintain`, `next_maintain`, `location`) 
VALUES 
('Treadmill', 'Cardio', 'TechnoGym', 'Run 500', 'Available', '2023-01-10', '2024-01-01 10:00:00', '2024-04-01 10:00:00', 'Cardio Area 1'),
('Elliptical', 'Cardio', 'LifeFitness', 'E5', 'Available', '2023-02-15', '2024-01-05 14:00:00', '2024-04-05 14:00:00', 'Cardio Area 2'),
('Smith Machine', 'Strength', 'Hammer Strength', 'Smith Pro', 'Available', '2023-03-20', '2024-01-03 09:00:00', '2024-04-03 09:00:00', 'Weight Area 1'),
('Dumbbell Set', 'Strength', 'Rogue', 'Hex Dumbbell Set', 'Available', '2023-01-05', '2024-01-02 11:00:00', '2024-04-02 11:00:00', 'Weight Area 2');
