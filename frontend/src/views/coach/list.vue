  ...
  <div class="coach-list-container">
    <el-card>
      <div class="toolbar">
        <el-form :inline="true" :model="queryForm">
          <el-form-item label="教练姓名">
            <el-input v-model="queryForm.coachName" placeholder="请输入教练姓名" clearable></el-input>
          </el-form-item>
          <el-form-item label="专长">
            <el-input v-model="queryForm.specialty" placeholder="请输入专长" clearable></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <div class="table-wrapper">
        ...
        <el-table-column prop="coachName" label="教练姓名" width="100"></el-table-column>
        ...
        <el-table-column prop="specialty" label="专长" width="120"></el-table-column>
        <el-table-column prop="experienceYears" label="从业年限" width="80"></el-table-column>
        <el-table-column prop="certification" label="资质证书" width="150"></el-table-column>
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="600px">
      <el-form ref="dataForm" :model="formData" :rules="rules" label-width="100px">
        <el-form-item label="教练姓名" prop="coachName">
          <el-input v-model="formData.coachName" placeholder="请输入教练姓名"></el-input>
        </el-form-item>
        ...
        <el-form-item label="专长" prop="specialty">
          <el-input v-model="formData.specialty" placeholder="请输入专长"></el-input>
        </el-form-item>
        <el-form-item label="从业年限" prop="experienceYears">
          <el-input-number v-model="formData.experienceYears" :min="0" :max="50"></el-input-number>
        </el-form-item>
        <el-form-item label="资质证书" prop="certification">
          <el-input v-model="formData.certification" placeholder="请输入资质证书"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      this.$confirm('确定要删除该教练吗？', '提示', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'warning'
      }).then(() => {
        deleteCoach(row.coachId).then(() => {
    ...
    handleSubmit() {
      this.$refs.dataForm.validate(valid => {
        if (valid) {
          const api = this.formData.coachId ? updateCoach : addCoach
          api(this.formData).then(() => {
            this.$message.success(this.formData.coachId ? '更新成功' : '添加成功')
